...
public class ReadToFile {
    public static void main(String[] args) {
        try(FileInputStream file = new FileInputStream("src/main/resources/dataLogin.xlsx")) {
            ...
            System.err.println("Da xay ra loi khi doc file excel");
        }
    }
}
